...
加锁前对象头的Mark Word中存储了对象的运行时数据，包括对象的哈希值、对象的锁状态、对象的分代年龄等信息。 
...
| ptr_to_heavyweight_monitor:30 \| 10                  | GHeavyweight Locked |
| \| 11                                                | Marked for GC       |
...
| ptr_to_heavyweight_monitor:62 \| 10                          | GHeavyweight Locked |
| \| 11                                                        | Marked for GC       |
...
![1](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/1.png)
...
![2](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/2.png)
...
![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/3.png)
...
* 创建锁记录（Lock Record）对象，每个线程的**栈帧**都会包含一个锁记录的结构，存储锁定对象的 Mark Word
  ...
  ![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/4.png)

* 让锁记录中 Object reference 指向锁住的对象，并尝试用 CAS 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录

* 如果 CAS 替换成功，对象头中存储了锁记录地址和状态 00（轻量级锁） ，表示由该线程给对象加锁
  ![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/5.png)
...
* 如果 CAS 失败，有两种情况：
  ...
  * 如果是线程自己执行了 synchronized 锁重入，就添加一条 Lock Record 作为重入的计数
  ...
  ![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/6.png)
...
* 当 Thread-1 进行轻量级加锁时，Thread-0 已经对该对象加了轻量级锁
  ...
  ![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/7.png)

* Thread-1 加轻量级锁失败，进入锁膨胀流程：为 Object 对象申请 Monitor 锁，**通过 Object 对象头获取到持锁线程**，将 Monitor 的 Owner 置为 Thread-0，将 Object 的对象头指向重量级锁地址，然后自己进入 Monitor 的 EntryList BLOCKED

  ![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/8.png)
...
![](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/9.png)
