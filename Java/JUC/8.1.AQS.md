...
- 请求的共享资源被占用，AQS 用队列实现线程阻塞等待以及被唤醒时锁分配的机制，将暂时获取不到锁的线程加入到队列中
  ...
  ![img](https://chocoh.oss-cn-guangzhou.aliyuncs.com/assets/Java/JUC/35)
